...
import no.uio.ifi.in2000.team11.havvarselapp.ui.weatherwithalert.ValidImageWeather

@Preview
@Composable
fun WeatherAlertScreen(forecastViewModel: LocationForecastViewModel = viewModel()){
