...
**Main flow**:
The user opens the application and the main screen (map) is loaded, showing Oslo and the Oslofjord as a hard coded start position. At the same time, data about the weather and sea conditions in this area is loaded on the other screen.
The user searches for the area he is interested in to check available guest harbours and gas stations there.
No meteorological alerts appear on the map for the new area.
The user clicks on different guest harbors to check available facilities there.
The user navigates to the weather screen to check the weather and sea conditions.
